...
class NegProcessor(TagProcessor):
    def __init__(self):
        ...
        self.not_set = {l.strip() for l in codecs.open(CURR_DICT + "/../dictionary/negative_word.txt", encoding='utf-8').readlines()}
        self.mode_change = {l.strip() for l in codecs.open(CURR_DICT + "/../dictionary/change.txt", encoding='utf-8').readlines()}
